...
Implemented: atan2, cos, exp, gsub, int, length, log, rand, sprintf, srand, sin, split, sub, substr, sqrt, tolower, toupper

Not Implemented: close, index, match, system. All high priority.
