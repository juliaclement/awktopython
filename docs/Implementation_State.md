...
Implemented: atan2, cos, exp, gsub, index, int, length, log, match, rand, sprintf, srand, sin, split, sub, substr, sqrt, tolower, toupper

Not Implemented: close, system. Both high priority.
